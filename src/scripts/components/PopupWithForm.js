...
export default class PopupWithForm extends Popup {
  ...
  _setSubmitButtonsTextsIntial() {
    this._submitButton.textContent = this._submitButtonsTexts.initial[
      `${this._submitText}`
    ];
  }

  changeSubmitButtonsText() {
    this._submitButton.textContent = this._submitButtonsTexts.changed[
      `${this._submitText}`
    ];
  }
  ...
  openPopup() {
    super.openPopup();
    this._setSubmitButtonsTextsIntial();
  }
